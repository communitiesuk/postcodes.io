...
POSTGRES_CONNECTION_TIMEOUT # Max ms to wait for a DB connection (pool slot or new connection incl. auth) before returning 503 (default 5000, 0 waits indefinitely)
